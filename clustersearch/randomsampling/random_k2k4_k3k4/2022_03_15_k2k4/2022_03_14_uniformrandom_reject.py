...
while npt<npts:
    ntrials+=1
    ktia0,ktan0,ktin0,ktni0,ktinA,ktiaB=np.random.uniform(0,4,size=6)
    ...
    if cont:
        ...
        parvals=np.concatenate((np.array([ktia0,ktan0,ktin0,ktni0,ktia0,ktan0,ktinA,ktni0,ktiaB,ktan0,ktin0,ktni0]),np.tile(b_u,6)))
