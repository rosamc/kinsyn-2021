...
cases=["any","difAD_difbnp","difAD_samebnp","difAD_samebnp_step12","difAD_samebnp_step13","difAD_samebnp_step23","difAD_samebnp_step11","sameAD_difbp","sameAD_difbp_kuonly","sameAD_difbnp","empty"]
...
fc1fc2="fc1=%d_fc2=%d"%(fc1,fc2)
mat=np.load("2020_03_15_mats_kPolconstr1000_tocontinue/mat_%s_%s.npy"%(case,fc1fc2))
mat_pars=np.load("2020_03_15_mats_kPolconstr1000_tocontinue/mat_pars_%s_%s.npy"%(case,fc1fc2))
...
name_save='%s_fcd=%g_fcu=%g_fc1=%g_fc2=%g'%(case,fcd,fcu,fc1,fc2)
